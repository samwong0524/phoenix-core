...
/**
 * Shared route-level error card used by all route error.tsx boundaries.
 * Extracted from duplicated implementations in workflow/error.tsx and graph/error.tsx.
 */
